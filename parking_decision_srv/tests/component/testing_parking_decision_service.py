...
from parking_decision_srv.db.migrations.setup_db_schema import setup_db_schema
...
class TestParkingDecisionService(TestCase):
    ...
    def test_get_decision_parking_using_requests(self):
        # Arrange
        payload = {'file': '/parking-decision-service/parking_decision_srv/helpers/31d5L5y.jpeg',
                   'name': "31d5L5y.jpeg"}
        # Act
